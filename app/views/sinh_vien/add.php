            ...
            <form class="forms-sample" method="POST" action="<?= BASE_URL . '/sinh-vien/save-create'; ?>" enctype="multipart/form-data">
                ...
                <div class="row">
                    <div class="form-group col-6">
                        ...
                        <input type="text" class="form-control" id="ho_dem" name="ho_dem" placeholder="Họ đệm" onchange="ten_dang_nhap()">
                    </div>
                    <div class="form-group col-6">
                        <label for="ten">Tên</label>
                        <input type="text" class="form-control" id="ten" name="ten" placeholder="Tên" onchange="ten_dang_nhap()">
                    </div>
                </div>
                <div class="row">
                    <div class="form-group col-6">
                        <label for="ho_dem">Tên tài khoản</label>
                        <input type="text" class="form-control" id="ten_tai_khoan" name="ten_tai_khoan" readonly>
                    </div>
                    <div class="form-group col-6">
