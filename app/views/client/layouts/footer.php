                ...
                <div class="row">
                    <div class="col-lg-3 col-md-6 col-12">
                        ...
                        <div class="f-about single-footer">
                            <div class="logo">
                                <a href="index.html"><img src="<?=BASE_URL.'/public/client';?>/images/logo/logo.svg" alt="Logo"></a>
                            </div>
                    ...
                    <div class="col-lg-3 col-md-6 col-12">
                        ...
                        <div class="single-footer sm-custom-border recent-blog">
                            ...
                            <ul>
                                <li>
                                    <a href="blog-single-sidebar.html"><img src="<?=BASE_URL.'/public/client';?>/images/blog/footer-news1.jpg" alt="#">
                                        Top 10 books you Must read in 2023
                                    </a>
                                    <span class="date"><i class="lni lni-calendar"></i>July 15, 2023</span>
                                </li>
                                <li>
                                    <a href="blog-single-sidebar.html"><img src="<?=BASE_URL.'/public/client';?>/images/blog/footer-news2.jpg" alt="#">
