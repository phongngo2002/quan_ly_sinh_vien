            ...
            <form class="forms-sample" method="POST" id="form-edit" action="<?= BASE_URL . '/quan-tri-vien/save-edit'; ?>">
                <div class="row p-0">
                    ...
                    <div class="form-group col-6">
                        ...
                        <input type="text" class="form-control" id="ho_dem" name="ho_dem" placeholder="Họ đệm" onchange="get_ten_tk()" value="<?= $qtr_vien->ho_dem ?>">
                    </div>
                    <div class="form-group col-6">
                        <label for="ten">Tên</label>
                        <input type="text" class="form-control" id="ten" name="ten" placeholder="Tên" onchange="get_ten_tk()" value="<?= $qtr_vien->ten ?>">
                    </div>
                </div>
                <div class="form-group">
                    <label for="ten_tai_khoan">Tên tài khoản</label>
                    <input type="text" class="form-control" id="ten_tai_khoan" name="ten_tai_khoan" value="<?= $qtr_vien->ten_tai_khoan ?>" readonly>
                </div>
                <div class="form-group">
                    <label for="mat_khau">Mật khẩu</label>
                    <input type="password" class="form-control" id="mat_khau" name="mat_khau" value="<?= $qtr_vien->mat_khau ?>">
                </div>
                <button type="submit" class="btn btn-success mr-2">Lưu</button>
                <a href="<?= BASE_URL . '/quan-tri-vien'; ?>"> <button type="button" class="btn btn-light">Hủy</button></a>
            </form>
        </div>
    </div>
</div>
<script>
    ...
    function get_ten_tk() {
        ...
        const so_tk = Number(document.getElementById('id').value);
        let first = '';
        let last = '';
